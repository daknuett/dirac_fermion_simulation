...
from lib.experiment import experiment_with_potential_time_evolution_optimized
...
if __name__ == "__main__":
    with log_time(__name__, "setup"):
        ...
        qbits_py = []
        ancilla_qbits = [N + 1, N + 2, N + 3, N + 4, N + 5]
    ...
    with log_time(__name__, "save results"):
        with open("simulation_with_potential_optimized.json", "w") as fout:
            data = config
