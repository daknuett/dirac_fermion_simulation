...
from .readout import compute_all_amplitudes, res2momentum
...
def experiment_with_potential_scattering_angle(qbits_px, qbits_py, qbits_phi, ancillas, ptot, phi_init, antifermion, c, dt, V0, N, momentum_omegas, eps, angle, t):
...
def experiment_optimized_scattering_angle(qbits_px, qbits_py, qbits_phi, ancillas, ptot, phi_init, antifermion, c, dt, V0, N, momentum_omegas, eps, angle, t):
    ...
    with log_time(__name__, "experiment_with_potential_scattering_angle"):
        ...
        px, py, phi = compute_all_amplitudes(state, qbits_px, qbits_py, qbits_phi, eps, c, N, momentum_omegas)
    return res2momentum(px_init, c, N, momentum_omegas), res2momentum(py_init, c, N, momentum_omegas), px, py, phi
